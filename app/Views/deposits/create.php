...
?>
<div class="container-fluid deposit-create-page">
    ...
    <div class="customer-page-header mb-4">
        ...
        <div>
            ...
            <p class="text-muted mb-0">
                ...
                Record a new customer deposit or transfer.
    ...
    <form
        action="<?= base_url('deposits/store') ?>"
        method="POST">
        ...
        Bank or transaction charges.
                            ...
                            <div class="col-12">
                                ...
                                <textarea
                                    ...
                                    rows="4"
                                    class="form-control"
                                    placeholder="Optional transaction description..."></textarea>
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="mb-0 mt-1">
                                ...
                                Make sure the customer, account name,
                ...
                <div class="card customer-form-card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-center py-4">
                            ...
                            <i
                                class="fas fa-money-bill-transfer fa-4x text-primary mb-3">
                            </i>
